---
title: Update your Windows 7 SP1 and Server 2008 R2 SP1
date: 2013-07-22
categories:
- server-2008-r2
- vista-7
...
{{< lead >}}
In case you've missed it, Microsoft released a roll-up update Hotfix for Windows 7 SP1 and Server 2008 R2 SP1 which includes 90 updates (!) post-SP1 - [An enterprise hotfix rollup is available for Windows 7 SP1 and Windows Server 2008 R2 SP1](http://support.microsoft.com/kb/2775511)
{{< /lead >}}
